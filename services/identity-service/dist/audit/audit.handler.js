...
export function auditHandler(db) {
    ...
    router.get('/', requireAuth, asyncHandler(async (req, res) => {
        ...
        const memberCheck = await db.query(`SELECT role FROM workspace_members WHERE workspace_id = $1 AND user_id = $2`, [workspaceId, req.auth.userId]);
